    ...
    public class ExperimentEngine : LabExperimentEngine
    {
        ...
        public override ExperimentInfo RunExperiment(ExperimentInfo experimentInfo)
        {
            ...
            try
            {
                ...
                {
                    driver = new DriverRadioactivityVsTime(this.labExperimentInfo.cancelExperiment);
                }
                else if (specification.SetupId.Equals(Consts.STRXML_SetupId_RadioactivityVsDistance))
                {
                    driver = new DriverRadioactivityVsDistance(this.labExperimentInfo.cancelExperiment);
                }
                else if (specification.SetupId.Equals(Consts.STRXML_SetupId_SimActivityVsTime))
                {
                    driver = new DriverSimActivityVsTime(this.labExperimentInfo.cancelExperiment);
                }
                else if (specification.SetupId.Equals(Consts.STRXML_SetupId_SimActivityVsDistance))
                {
                    driver = new DriverSimActivityVsDistance(this.labExperimentInfo.cancelExperiment);
                }
