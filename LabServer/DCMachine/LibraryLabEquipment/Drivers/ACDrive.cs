...
namespace Library.LabEquipment.Drivers
{
    public class ACDrive
    {
        ...
        public const int DELAY_StopDrive = 5;
        ...
        public const int MINIMUM_MinimumTorque = -10;
        public const int MINIMUM_MaximumTorque = 10;
        ...
        public void EnableDrivePower()
        {
            ...
            try
            {
                ushort[] regs = new ushort[2] { 0x0000, 0x1000 };
        ...
        public void ResetDrive()
        {
            ...
            try
            {
                ushort[] regs = new ushort[2] { 0x09a1, 0x1000 };
        ...
        public void StartDrive()
        {
            ...
            try
            {
                ushort[] regs = new ushort[2] { 0x08a2, 0x1000 };
        ...
        public void StopDrive()
        {
            ...
            try
            {
                ushort[] regs = new ushort[2] { 0x08a1, 0x1000 };
