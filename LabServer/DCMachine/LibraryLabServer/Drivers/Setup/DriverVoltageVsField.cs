...
{
    public class DriverVoltageVsField : DriverGeneric
    {
        ...
        {
            sCreateConnection,
            sResetACDrive, sResetDCDriveMut, sConfigureACDrive, sConfigureDCDriveMut, sStartACDrive, sEnableDCDriveMut,
        ...
        public DriverVoltageVsField(int unitId)
            : this(unitId, null)
        {
        }
        ...
        public DriverVoltageVsField(int unitId, CancelExperiment cancelExperiment)
                ...
                switch (state)
                {
                    ...
                    case States.sConfigureACDrive:
                        ...
                        RedLion.ACDriveConfiguration setACConfig = new RedLion.ACDriveConfiguration(
                            ACDrive.MAXIMUM_Speed, 0, ACDrive.DEFAULT_SpeedRampTime, ACDrive.DEFAULT_MaximumCurrent,
                    ...
                    case States.sStartACDrive:
                        ...
                        {
                            state = States.sEnableDCDriveMut;
                            break;
                        }
