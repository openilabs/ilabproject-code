...
namespace Library.LabServer.Drivers.Setup
{
    public partial class DriverSpeedVsField : DriverEquipmentGeneric
    {
        ...
        private SMTableEntry_Execute[] smTable_Execute = new SMTableEntry_Execute[] {
            ...
            // CreateConnection
            //
            new SMTableEntry_Execute(States_Execute.sCreateConnection, States_Execute.sGetDCDriveMutInfo, States_Execute.sResumePowerdown,
            ...
            new SMTableEntry_Execute(States_Execute.sConfigureACDrive, States_Execute.sConfigureDCDriveMut, States_Execute.sReconfigureACDrive,
                Consts.STRXML_CmdConfigureACDrive, new string[,] {
                    { Consts.STRXML_ReqACDriveConfig, Consts.STR_ACDriveConfig_MinimumTorque }
                } ),
            //
            // ConfigureDCDriveMut
            //
            ...
            // SetSpeedDCDriveMut
            //
            new SMTableEntry_Execute(States_Execute.sSetSpeedDCDriveMut, States_Execute.sSetFieldDCDriveMut, States_Execute.sStopDCDriveMut,
            ...
            // SetFieldDCDriveMut
            //
            new SMTableEntry_Execute(States_Execute.sSetFieldDCDriveMut, States_Execute.sTakeMeasurement, States_Execute.sStopDCDriveMut,
            ...
            // TakeMeasurement
            //
            new SMTableEntry_Execute(States_Execute.sTakeMeasurement, States_Execute.sResetFieldDCDriveMut, States_Execute.sStopDCDriveMut,
                Consts.STRXML_CmdTakeMeasurement, null),
            //
            // ResetFieldDCDriveMut
            //
            new SMTableEntry_Execute(States_Execute.sResetFieldDCDriveMut, States_Execute.sResetSpeedDCDriveMut, States_Execute.sStopDCDriveMut,
                Consts.STRXML_CmdSetFieldDCDriveMut, new string[,] {
                    { Consts.STRXML_ReqFieldDCDriveMut, string.Empty }
                } ),
            //
                ...
                while (state != States_Execute.sCompleted)
                {
                    ...
                    switch (entry.currentState)
                    {
                        case States_Execute.sSetSpeedDCDriveMut:
                            int speedDCDriveMut = maxSpeedDCDriveMut / 2;
                    ...
                    switch (entry.currentState)
                    {
                        case States_Execute.sGetDCDriveMutInfo:
                            maxSpeedDCDriveMut = XmlUtilities.GetIntValue(xmlResponseNode, Consts.STRXML_RspMaxSpeed, 0);
