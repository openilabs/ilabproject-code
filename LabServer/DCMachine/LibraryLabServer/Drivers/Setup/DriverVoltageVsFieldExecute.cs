...
namespace Library.LabServer.Drivers.Setup
{
    public partial class DriverVoltageVsField : DriverEquipmentGeneric
    {
        ...
        private SMTableEntry_Execute[] smTable_Execute = new SMTableEntry_Execute[] {
            ...
            // StartDCDriveMut
            //
            new SMTableEntry_Execute(States_Execute.sStartDCDriveMut, States_Execute.sSetFieldDCDriveMut, States_Execute.sStopDCDriveMut,
            ...
            // SetFieldDCDriveMut
            //
            new SMTableEntry_Execute(States_Execute.sSetFieldDCDriveMut, States_Execute.sTakeMeasurement, States_Execute.sResetFieldDCDriveMut,
                Consts.STRXML_CmdSetFieldDCDriveMut, new string[,] {
                    { Consts.STRXML_ReqFieldDCDriveMut, string.Empty }
                } ),
            //
            // TakeMeasurement
            //
            new SMTableEntry_Execute(States_Execute.sTakeMeasurement, States_Execute.sResetFieldDCDriveMut, States_Execute.sResetFieldDCDriveMut,
                Consts.STRXML_CmdTakeMeasurement, null),
            //
            // ResetFieldDCDriveMut
            //
            new SMTableEntry_Execute(States_Execute.sResetFieldDCDriveMut, States_Execute.sStopDCDriveMut, States_Execute.sStopDCDriveMut,
                Consts.STRXML_CmdSetFieldDCDriveMut, new string[,] {
                    { Consts.STRXML_ReqFieldDCDriveMut, string.Empty }
                } ),
            //
            ...
            try
            {
                ...
                while (state != States_Execute.sCompleted)
                {
                    ...
                    switch (entry.currentState)
                    {
                        ...
                        case States_Execute.sSetFieldDCDriveMut:
                            int fieldDCDriveMut = specification.Field.max - (vectorIndex * specification.Field.step);
                            entry.commandArguments[0, 1] = fieldDCDriveMut.ToString();
                            break;

                        case States_Execute.sResetFieldDCDriveMut:
                            fieldDCDriveMut = defaultFieldDCDriveMut;
                            entry.commandArguments[0, 1] = fieldDCDriveMut.ToString();
                            break;
                    ...
                    switch (entry.currentState)
                    {
                        ...
                        case States_Execute.sGetDCDriveMutInfo:
                            defaultFieldDCDriveMut = XmlUtilities.GetIntValue(xmlResponseNode, Consts.STRXML_RspDefaultField, 0);
                            break;
                        ...
                        case States_Execute.sTakeMeasurement:
                            ...
                            if (++repeatCount == this.measurementCount)
                            {
                                ...
                                //
                                repeatCount = 0;
                                nextState = States_Execute.sSetFieldDCDriveMut;
                                break;
                            }
