...
namespace Library.LabServer.Drivers.Setup
{
    public partial class DriverSpeedVsVoltage : DriverEquipmentGeneric
    {
        ...
        private enum States_GetExecutionTime
        {
            ...
            sGetSetSpeedDCDriveMutTime,
            sGetTakeMeasurementTime,
            sGetResetSpeedDCDriveMutTime,
        ...
        private SMTableEntry_GetExecutionTime[] smTable_GetExecutionTime = new SMTableEntry_GetExecutionTime[] {
            ...
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetConfigureACDriveTime, States_GetExecutionTime.sGetConfigureDCDriveMutTime,
            ...
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetStartDCDriveMutTime, States_GetExecutionTime.sGetSetSpeedDCDriveMutTime,
                Consts.STRXML_CmdGetStartDCDriveMutTime, new string[,] {
                    { Consts.STRXML_ReqDCDriveMutMode, Consts.STR_DCDriveMutMode_Speed },
                }
                ),
            //
            // GetSetSpeedDCDriveMutTime
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetSetSpeedDCDriveMutTime, States_GetExecutionTime.sGetTakeMeasurementTime,
                Consts.STRXML_CmdGetSetSpeedDCDriveMutTime, null
                ),
            //
            // GetTakeMeasurementTime
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetTakeMeasurementTime, States_GetExecutionTime.sGetResetSpeedDCDriveMutTime,
                Consts.STRXML_CmdGetTakeMeasurementTime, null
                ),
            //
            // GetResetSpeedDCDriveMutTime
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetResetSpeedDCDriveMutTime, States_GetExecutionTime.sGetStopDCDriveMutTime,
                Consts.STRXML_CmdGetSetSpeedDCDriveMutTime, null
                ),
            //
            ...
            try
            {
                ...
                while (state != States_GetExecutionTime.sCompleted)
                {
                    ...
                    switch (entry.currentState)
                    {
                        ...
                        case States_GetExecutionTime.sGetSetSpeedDCDriveMutTime:
                            double setSpeedDCDriveMutTime = XmlUtilities.GetRealValue(xmlResponseNode, Consts.STRXML_RspSetSpeedDCDriveMutTime, 0);
                            stateExecutionTime = vectorLength * this.measurementCount * setSpeedDCDriveMutTime;
                            break;
                        ...
                        case States_GetExecutionTime.sGetResetSpeedDCDriveMutTime:
                            stateExecutionTime = XmlUtilities.GetRealValue(xmlResponseNode, Consts.STRXML_RspSetSpeedDCDriveMutTime, 0);
                            break;
