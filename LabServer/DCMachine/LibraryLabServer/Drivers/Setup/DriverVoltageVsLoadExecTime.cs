...
namespace Library.LabServer.Drivers.Setup
{
    public partial class DriverVoltageVsLoad : DriverEquipmentGeneric
    {
        ...
        private enum States_GetExecutionTime
        {
            ...
            sGetSetTorqueDCDriveMutTime,
            sGetTakeMeasurementTime,
            sGetResetTorqueDCDriveMutTime,
        ...
        private SMTableEntry_GetExecutionTime[] smTable_GetExecutionTime = new SMTableEntry_GetExecutionTime[] {
            ...
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetStartDCDriveMutTime, States_GetExecutionTime.sGetSetTorqueDCDriveMutTime,
                Consts.STRXML_CmdGetStartDCDriveMutTime, new string[,] {
                    { Consts.STRXML_ReqDCDriveMutMode, Consts.STR_DCDriveMutMode_Torque },
                }
                ),
            //
            // GetSetTorqueDCDriveMutTime
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetSetTorqueDCDriveMutTime, States_GetExecutionTime.sGetTakeMeasurementTime,
                Consts.STRXML_CmdGetSetTorqueDCDriveMutTime, null
                ),
            //
            // GetTakeMeasurementTime
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetTakeMeasurementTime, States_GetExecutionTime.sGetResetTorqueDCDriveMutTime,
                Consts.STRXML_CmdGetTakeMeasurementTime, null
                ),
            //
            // GetResetTorqueDCDriveMutTime
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetResetTorqueDCDriveMutTime, States_GetExecutionTime.sGetStopDCDriveMutTime,
                Consts.STRXML_CmdGetSetTorqueDCDriveMutTime, null
                ),
            //
        ...
        public override int GetExecutionTime(ExperimentSpecification experimentSpecification)
        {
            ...
            //
            string logMessage = STRLOG_LoadMin + specification.Load.min.ToString() +
                Logfile.STRLOG_Spacer + STRLOG_LoadMax + specification.Load.max.ToString() +
                Logfile.STRLOG_Spacer + STRLOG_LoadStep + specification.Load.step.ToString();
            ...
            try
            {
                ...
                while (state != States_GetExecutionTime.sCompleted)
                {
                    ...
                    switch (entry.currentState)
                    {
                        ...
                        case States_GetExecutionTime.sGetSetTorqueDCDriveMutTime:
                            double setTorqueDCDriveMutTime = XmlUtilities.GetRealValue(xmlResponseNode, Consts.STRXML_RspSetTorqueDCDriveMutTime, 0);
                            stateExecutionTime = vectorLength * this.measurementCount * setTorqueDCDriveMutTime;
                            break;
                        ...
                        case States_GetExecutionTime.sGetResetTorqueDCDriveMutTime:
                            stateExecutionTime = XmlUtilities.GetRealValue(xmlResponseNode, Consts.STRXML_RspSetTorqueDCDriveMutTime, 0);
                            break;
