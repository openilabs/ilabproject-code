...
namespace Library.LabServer.Drivers.Setup
{
    public partial class DriverSpeedVsField : DriverEquipmentGeneric
    {
        ...
        private SMTableEntry_GetExecutionTime[] smTable_GetExecutionTime = new SMTableEntry_GetExecutionTime[] {
            ...
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetSetSpeedDCDriveMutTime, States_GetExecutionTime.sGetSetFieldDCDriveMutTime,
                ...
                while (state != States_GetExecutionTime.sCompleted)
                {
                    ...
                    switch (entry.currentState)
                    {
                        ...
                        case States_GetExecutionTime.sGetSetFieldDCDriveMutTime:
                            ...
                            stateExecutionTime = vectorLength * this.measurementCount * setFieldDCDriveMutTime;
                            break;
