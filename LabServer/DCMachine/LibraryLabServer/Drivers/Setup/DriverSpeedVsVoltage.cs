...
{
    public class DriverSpeedVsVoltage : DriverGeneric
    {
        ...
        public DriverSpeedVsVoltage(int unitId)
            : this(unitId, null)
        {
        }
        ...
        public DriverSpeedVsVoltage(int unitId, CancelExperiment cancelExperiment)
        ...
        public override int GetExecutionTime(ExperimentSpecification experimentSpecification)
        {
            ...
            int measurementsTime = this.redLion.SetSpeedDCDriveMutExecutionTime();
            measurementsTime += this.redLion.MeasurementCount * this.redLion.MeasurementDelay;
            executionTime += (vectorLength * measurementsTime) + this.redLion.SetSpeedDCDriveMutExecutionTime();
                ...
                switch (state)
                {
                    ...
                    case States.sConfigureACDrive:
                        ...
                        RedLion.ACDriveConfiguration setACConfig = new RedLion.ACDriveConfiguration(
                            0, 0, ACDrive.DEFAULT_SpeedRampTime, 4500,
                    ...
                    case States.sTakeMeasurements:
                        ...
                        if (vectorIndex == vectorLength)
                        {
                            ...
                            if (this.redLion.SetSpeedDCDriveMut(0) == false)
                            {
                                //
                                // Failed
                                //
