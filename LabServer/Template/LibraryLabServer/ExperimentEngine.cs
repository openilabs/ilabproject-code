    ...
    public class ExperimentEngine : LabExperimentEngine
    {
        ...
        public override ExperimentInfo RunExperiment(ExperimentInfo experimentInfo)
        {
            ...
            try
            {
                ...
                //
                if (specification.SetupId.Equals(Consts.STRXML_SetupId_Equipment))
                {
                ...
                else if (specification.SetupId.Equals(Consts.STRXML_SetupId_Simulation))
                {
                    DriverSimulation driver = new DriverSimulation(this.configuration, this.labExperimentInfo.cancelExperiment);
                    resultInfo = (ResultInfo)driver.Execute(specification);
                }
                //
                // ... AND HERE
