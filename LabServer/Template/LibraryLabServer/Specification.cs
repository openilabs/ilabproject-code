    ...
    public class Specification : ExperimentSpecification
    {
        ...
        public override ValidationReport Parse(string xmlSpecification)
        {
            ...
            try
            {
                ...
                //
                // YOUR CODE HERE
                if (this.setupId.Equals(Consts.STRXML_SetupId_Equipment))
                {
                ...
                else if (this.setupId.Equals(Consts.STRXML_SetupId_Simulation))
                {
                    DriverSimulation driver = new DriverSimulation(this.configuration);
                    executionTime = driver.GetExecutionTime(this);
                }
                //
                //
