...
namespace LabServer
{
    class LockedRotor
    {
        ...
        // Constructor
        //
        public LockedRotor(string ipAddress, int portNum)
        {
            Trace.WriteLine("LockedRotor(): Called");
        ...
        public void Execute()
        {
            Trace.WriteLine("LockedRotor.Execute(): Called");
            ...
            Trace.WriteLine("LockedRotor.Execute(): Completed ");
        ...
        {
            Trace.WriteLine("LockedRotor.ExecutionTime():");
