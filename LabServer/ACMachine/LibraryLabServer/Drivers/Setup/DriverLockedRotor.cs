...
{
    public class DriverLockedRotor : DriverGeneric
    {
        ...
        public DriverLockedRotor(int unitId)
            : this(unitId, null)
        {
        }
        ...
        public DriverLockedRotor(int unitId, CancelExperiment cancelExperiment)
        ...
        public override int GetExecutionTime(ExperimentSpecification experimentSpecification)
        {
            ...
            executionTime += this.redLion.StartACDriveExecutionTime(RedLion.ACDriveModes.LockedRotor);
            ...
            //
            executionTime += this.redLion.StopACDriveExecutionTime(RedLion.ACDriveModes.LockedRotor);
            executionTime += this.redLion.ConfigureACDriveExecutionTime();
            ...
            while (true)
            {
                switch (state)
                {
                    ...
                    case States.sStartACDrive:
                        ...
                        // Start AC drive
                        //
                        if (this.redLion.StartACDrive(RedLion.ACDriveModes.LockedRotor) == true)
                        {
                            measurementNumber = 0;
                    ...
                    case States.sStopACDrive:
                        ...
                        // Stop the AC drive
                        //
                        if (this.redLion.StopACDrive(RedLion.ACDriveModes.LockedRotor) == false)
                        {
                            //
                            // Failed
                            //
