...
{
    class DriverSynchronousSpeed : DriverGeneric
    {
        ...
        public DriverSynchronousSpeed(int unitId)
            : this(unitId, null)
        {
        }
        ...
        public DriverSynchronousSpeed(int unitId, CancelExperiment cancelExperiment)
        ...
        public override int GetExecutionTime(ExperimentSpecification experimentSpecification)
        {
            ...
            executionTime += this.redLion.StartACDriveExecutionTime(RedLion.ACDriveModes.SynchronousSpeed);
            ...
            //
            executionTime += this.redLion.StopACDriveExecutionTime(RedLion.ACDriveModes.SynchronousSpeed);
            executionTime += this.redLion.ConfigureACDriveExecutionTime();
                ...
                switch (state)
                {
                    ...
                    case States.sConfigureACDrive:
                        ...
                        RedLion.ACDriveConfiguration setConfig = new RedLion.ACDriveConfiguration(
                            ACDrive.MAXIMUM_Speed, 0, ACDrive.DEFAULT_SpeedRampTime,
                    ...
                    case States.sStartACDrive:
                        ...
                        // Start AC drive
                        //
                        if (this.redLion.StartACDrive(RedLion.ACDriveModes.SynchronousSpeed) == true)
                        {
                            measurementNumber = 0;
                    ...
                    case States.sStopACDrive:
                        ...
                        // Stop the AC drive
                        //
                        if (this.redLion.StopACDrive(RedLion.ACDriveModes.SynchronousSpeed) == false)
                        {
                            //
                            // Failed
                            //
