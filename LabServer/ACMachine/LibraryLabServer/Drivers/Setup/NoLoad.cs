...
namespace LabServer
{
    class NoLoad
    {
        ...
        // Constructor
        //
        public NoLoad(string ipAddress, int portNum)
        {
            Trace.WriteLine("NoLoad(): Called");
        ...
        public void Execute()
        {
            Trace.WriteLine("NoLoad.Execute(): Called");
            ...
            Trace.WriteLine("NoLoad.Execute(): Completed ");
        ...
        {
            Trace.WriteLine("NoLoad.ExecutionTime():");
