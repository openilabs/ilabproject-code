...
{
    class DriverNoLoad : DriverGeneric
    {
        ...
        public DriverNoLoad(int unitId)
            : this(unitId, null)
        {
        }
        ...
        public DriverNoLoad(int unitId, CancelExperiment cancelExperiment)
        ...
        public override int GetExecutionTime(ExperimentSpecification experimentSpecification)
        {
            ...
            executionTime += this.redLion.StartACDriveExecutionTime(RedLion.ACDriveModes.NoLoad);
            ...
            //
            executionTime += this.redLion.StopACDriveExecutionTime(RedLion.ACDriveModes.NoLoad);
            executionTime += this.redLion.ConfigureACDriveExecutionTime();
            ...
            while (true)
            {
                switch (state)
                {
                    ...
                    case States.sStartACDrive:
                        ...
                        // Start AC drive
                        //
                        if (this.redLion.StartACDrive(RedLion.ACDriveModes.NoLoad) == true)
                        {
                            measurementNumber = 0;
                    ...
                    case States.sStopACDrive:
                        ...
                        // Stop the AC drive
                        //
                        if (this.redLion.StopACDrive(RedLion.ACDriveModes.NoLoad) == false)
                        {
                            //
                            // Failed
                            //
