...
namespace LabServer
{
    class FullLoad
    {
        ...
        // Constructor
        //
        public FullLoad(string ipAddress, int portNum)
        {
            Trace.WriteLine("FullLoad(): Called");
        ...
        public void Execute()
        {
            Trace.WriteLine("FullLoad.Execute(): Called");
            ...
            Trace.WriteLine("FullLoad.Execute(): Completed ");
        ...
        {
            Trace.WriteLine("FullLoad.ExecutionTime():");
