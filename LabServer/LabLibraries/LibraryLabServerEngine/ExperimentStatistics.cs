...
namespace Library.LabServerEngine
{
    public class ExperimentStatistics
    {
        ...
        private const string STRXML_timeSubmittedBinary = "timeSubmittedBinary";
        ...
        private const string STRXML_timeStartedBinary = "timeStartedBinary";
        private const string STRXML_unitId = "unitId";
        private const string STRXML_timeCompleted = "timeCompleted";
        private const string STRXML_timeCompletedBinary = "timeCompletedBinary";
        ...
        public ExperimentStatistics(string xmlTemplate, string filename)
        {
            ...
            try
            {
                ...
                XmlUtilities.GetXmlValue(xmlNode, STRXML_timeSubmittedBinary, true);
                ...
                XmlUtilities.GetXmlValue(xmlNode, STRXML_timeStartedBinary, true);
                XmlUtilities.GetXmlValue(xmlNode, STRXML_unitId, true);
                XmlUtilities.GetXmlValue(xmlNode, STRXML_timeCompleted, true);
                XmlUtilities.GetXmlValue(xmlNode, STRXML_timeCompletedBinary, true);
        ...
        public bool Submitted(QueuedExperimentInfo queuedExperimentInfo, DateTime timeSubmitted)
        {
            ...
            try
            {
                ...
                Logfile.Write(STRLOG_experimentId + queuedExperimentInfo.experimentId.ToString());
                Logfile.Write(STRLOG_sbName + queuedExperimentInfo.sbName);
                ...
                XmlUtilities.SetXmlValue(xmlNode, STRXML_timeSubmittedBinary, timeSubmitted.ToBinary().ToString(), false);
        ...
        public bool Started(int experimentId, string sbName, int unitId, DateTime timeStarted)
        {
            ...
            try
            {
                ...
                lock (this.fileLock)
                {
                    ...
                    //
                    // Fill in the time started information and unit Id
                    //
                    XmlUtilities.SetXmlValue(xmlNode, STRXML_timeStarted, timeStarted.ToString(), false);
                    XmlUtilities.SetXmlValue(xmlNode, STRXML_timeStartedBinary, timeStarted.ToBinary().ToString(), false);
        ...
        public bool Completed(int experimentId, string sbName, DateTime timeCompleted)
        {
            ...
            try
            {
                ...
                lock (this.fileLock)
                {
                    ...
                    XmlUtilities.SetXmlValue(xmlNode, STRXML_timeCompletedBinary, timeCompleted.ToBinary().ToString(), false);

                    //
                    // Calculate the actual execution time and save it
                    //
                    string timeStartedBinary = XmlUtilities.GetXmlValue(xmlNode, STRXML_timeStartedBinary, false);
        ...
        public bool Cancelled(int experimentId, string sbName, DateTime timeCancelled)
        {
            ...
            try
            {
                ...
                lock (this.fileLock)
                {
                    ...
                    XmlUtilities.SetXmlValue(xmlNode, STRXML_timeCompletedBinary, timeCancelled.ToBinary().ToString(), false);
