...
namespace Library.LabServerEngine
{
    public class LabConfiguration
    {
        ...
        public LabConfiguration(string xmlLabConfiguration)
            : this(xmlLabConfiguration, null)
        {
        }

        //---------------------------------------------------------------------------------------//

        public LabConfiguration(string xmlLabConfiguration, string labConfigFilename)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        // Get lab configuration filename
                        this.filename = rootFilePath +
                            Utilities.GetAppSetting(Consts.STRCFG_XmlLabConfigurationFilename);
                    }
                    else
                    {
                        // Prepend full file path
                        this.filename = rootFilePath + labConfigFilename;
                    }
