...
namespace Library.LabServerEngine
{
    public class LabServerToSbAPI
    {
        ...
        private const string STRLOG_Successful = "Successful";
        ...
        public bool Notify(int experimentId, string sbName)
        {
            ...
            //
            // Log success of notification
            //
            if (success == true)
            {
                logMessage = STRLOG_NotifyingServiceBroker + STRLOG_Successful;
            }
            else
            {
                logMessage = STRLOG_NotifyingServiceBroker + STRLOG_Failed;
            }
