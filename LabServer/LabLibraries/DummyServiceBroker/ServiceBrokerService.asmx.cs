...
namespace ServiceBroker
{
    ...
    public class ServiceBrokerService : System.Web.Services.WebService
    {
        ...
        private const string STR_ExperimentIdFilename = "ExperimentID.dat";
        //
        // Local variables
        //
        private static int experimentId = 0;
        ...
        public ServiceBrokerService()
        {
            ...
            Logfile.Write(" Experiment Id: " + experimentId.ToString());
        ...
        {
            LabServerWebService labServer = GetLabServer(sbHeader);
            SubmissionReport submissionReport = labServer.Submit(experimentId, experimentSpecification, userGroup, priorityHint);
        ...
        public void Notify(int experimentID)
        {
            try
            {
                ...
                //
                bool success = false;
                if (sbHeader != null && sbHeader.couponPassKey != null)
                {
                    ...
                    if (strSplit.Length == 3)
                    {
                        ...
                        //
                        if (sbHeader.couponPassKey.Equals(strSplit[0].Trim(), StringComparison.OrdinalIgnoreCase) == true)
                        {
                ...
                if (success == false)
                {
                    throw new Exception(STRLOG_AccessDenied);
                }
            }
            catch (Exception ex)
            {
        ...
        private int GetNextExperimentID()
        {
            ...
            string filename = Global.RootFilePath + STR_ExperimentIdFilename;
