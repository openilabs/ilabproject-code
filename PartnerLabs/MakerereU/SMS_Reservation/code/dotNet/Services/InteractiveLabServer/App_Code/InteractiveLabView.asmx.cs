...
namespace iLabs.LabServer.LabView
{
    ...
    [WebService(Name = "InteractiveLabView", Namespace = "http://localhost/iLabs/Services", Description = "LabVIEW Lab Server"),
    WebServiceBindingAttribute(Name = "LabViewLS", Namespace = "http://localhost/iLabs/Services")]
    [WebServiceBinding(Name = "I_ILS", Namespace = "http://localhost/iLabs/Services")]
