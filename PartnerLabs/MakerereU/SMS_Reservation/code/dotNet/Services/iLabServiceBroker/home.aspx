<%@ Page language="c#" Inherits="iLabs.ServiceBroker.iLabSB.home" CodeFile="home.aspx.cs" %>
...
-->
<!-- $Id: home.aspx,v 1.1.1.1 2006/02/07 22:10:57 pbailey Exp $ -->
	<HEAD>
				...
				<div id="innerwrapper">
					...
					<div id="pagecontent">
						<div id="messagebox-right">
							...
							</asp:Label><asp:repeater id="repSystemMessage" runat="server">
								<ItemTemplate>
									<p class="message">
