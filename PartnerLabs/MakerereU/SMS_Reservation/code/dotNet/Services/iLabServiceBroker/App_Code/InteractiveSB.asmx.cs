...
namespace iLabs.ServiceBroker.iLabSB
{
	...
	/// </summary>
	/// 
    [XmlType(Namespace = "http://localhost/iLabs/Type")]
    ...
    WebService(Name = "InteractiveServiceBroker", Namespace = "http://localhost/iLabs/Services",
...
*/
       ...
       SoapHeader("agentAuthHeader", Direction = SoapHeaderDirection.In)]
        ...
        [SoapDocumentMethod("http://localhost/iLabs/Type/SaveClientItem",Binding = "IServiceBroker")]      
        ...
        [SoapHeader("opHeader", Direction = SoapHeaderDirection.In, Required = true)]
        [SoapDocumentMethod("http://localhost/iLabs/Type/LoadClientItem", Binding = "IServiceBroker")]
        ...
        [SoapHeader("opHeader", Direction = SoapHeaderDirection.In, Required = true)]
        [SoapDocumentMethod("http://localhost/iLabs/Type/DeleteClientItem", Binding = "IServiceBroker")]
        ...
        [SoapHeader("opHeader", Direction = SoapHeaderDirection.In, Required = true)]
        [SoapDocumentMethod("http://localhost/iLabs/Type/ListAllClientItems", Binding = "IServiceBroker")]
