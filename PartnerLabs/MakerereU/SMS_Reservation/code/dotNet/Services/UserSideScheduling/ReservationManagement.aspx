<%@ Page language="c#" Inherits="iLabs.Scheduling.UserSide.ReservationManagement" CodeFile="ReservationManagement.aspx.cs" %>
	...
	<div id="outerwrapper">
		...
		<tr>
									...
									<tr>
										...
										<td style="width: 143px"><asp:textbox id="txtUserName" Runat="server" Width="100%" ></asp:textbox>
											</td>
									</tr>
									<tr>
										<th>
