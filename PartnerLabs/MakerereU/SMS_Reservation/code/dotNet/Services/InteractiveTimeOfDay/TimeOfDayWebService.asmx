...
{
    [WebService(Namespace = "http://localhost/iLabs/Services")]
    [XmlType(Namespace = "http://localhost/iLabs/type")]
    [WebServiceBinding(Name = "TimeOfDayWebService", Namespace = "http://localhost/iLabs/Services")]
    [WebServiceBinding(Name = "IProcessAgent", Namespace = "http://localhost/iLabs/Services")]
    [WebServiceBinding(Name = "ITimeOfDay", Namespace = "http://localhost/iLabs/Services")]
