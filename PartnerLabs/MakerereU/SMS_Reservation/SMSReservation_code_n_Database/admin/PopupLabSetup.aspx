<%@ Page Language="C#" MasterPageFile="~/admin/masterPages/MasterPagePopupWindow.master" AutoEventWireup="true" CodeFile="PopupLabSetup.aspx.cs" Inherits="PopupLabSetup" Title="New Configuration" %>
...
<asp:Content ID="Content4" runat="server" 
   ...
   <p>  <asp:Label ID="LabDescriptionID" runat="server" Text="Lab Description"></asp:Label> </p>
    ...
    <p> &nbsp;</p>
    <p> <asp:Label ID="appCallName" runat="server" Text="Lab acronym"></asp:Label> </p>
...
<asp:Content ID="Content5" runat="server" 
    ...
    <p> &nbsp;</p>
                                    ...
                                    <p><asp:TextBox ID="appCallNameBx" runat="server" Width="469px" Height="14px"></asp:TextBox></p>        
