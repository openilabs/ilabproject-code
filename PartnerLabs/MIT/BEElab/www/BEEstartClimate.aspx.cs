 ...
 * 
 * $Id: BEEstartAll.aspx.cs 880 2014-02-21 23:28:02Z phbailey $
 */
...
namespace iLabs.LabServer.BEE
{
	...
	/// </summary>
	public partial class BEEstartClimate : System.Web.UI.Page
	{
        ...
        protected void goButton_Click(object sender, System.EventArgs e)
        {
            ...
            if (task != null)
            {
               ...
               sendProfile(ConfigurationManager.AppSettings["climateController"],
                   hdnProfile.Value, hdnSunLamp.Value, ConfigurationManager.AppSettings["climateServer"]);
               sendFile(ConfigurationManager.AppSettings["chamberController"],
                ...
                sendEwsCientProfile(hdnClimateProfile.Value,hdnExpLength.Value);
