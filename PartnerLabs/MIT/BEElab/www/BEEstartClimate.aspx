<%@ Page language="c#" Inherits="iLabs.LabServer.BEE.BEEstartClimate" CodeFile="BEEstartClimate.aspx.cs"  EnableSessionState="true"%>
...
-->
 <meta charset="UTF-8" />
  ...
  <title>BEE Climate Lab Launch</title>
...
<nav>
   <ul class="navigation">
    <li>
      ...
      <input type='radio' class='js-add-load button'  name='js-active-load' value='2' id='load-1' checked="true"/>
    </li>
    <li>
      <label for='load-2' style='background-color:#FF9F67' class='button'>Load 2</label>
      <input type='radio' class='js-add-load button' name='js-active-load' value='3' id='load-2'/>
    </li>
    <li>
      <label for='load-3' style='background-color:#323138' class='button'>Load 3</label>
      <input type='radio' class='js-add-load button' name='js-active-load' value='4' id='load-3'/>
    </li>
    <li>
      <label for='load-4' style='background-color:#4C646B' class='button'>Load 4</label>
      <input type='radio' class='js-add-load button' name='js-active-load' value='5' id='load-4'/>
    </li>
    </ul>
</nav>
<nav>
