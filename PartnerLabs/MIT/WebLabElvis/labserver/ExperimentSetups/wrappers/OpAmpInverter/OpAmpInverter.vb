...
Namespace InstrumentDriverInterop.Ivi
    ...
    Public Class Inverter
        ...
        Public Function RunExperiment(ByVal frequencyHz As Double, ByVal peakAmplitudeV As Double, ByVal DCOffsetV As Double, ByVal waveformType As Short, ByVal SamplingRate As Double, ByVal SamplingTime As Double) As Double()()
            ...
            PInvoke.runExperiment(SCOPETriggerSlope_POSITIVE, SCOPETriggerType_Analog, SCOPETriggerSource_CH_A, SCOPEChannelSource_FGEN_FUNC_OUT, 10, 0, SCOPEChannelCoupling_DC, SCOPEChannelSource_ACH0, 10, 0, SCOPEChannelCoupling_DC, recordLength, SamplingRate, SCOPEAcquireMode_N_Samples, waveformType, frequencyHz, DCOffsetV, peakAmplitudeV, waveform(0), len)
            '"Dev1", True,                                                                                   
...
#End Region
        ...
        Private Class PInvoke
            ...
            <DllImport("D:\\iLabs\\WebLabElvis\\src\\labserver\\ExperimentSetups\\wrappers\\OpAmpInverter\\LabView\\SharedLib.dll", CallingConvention:=CallingConvention.StdCall)> _
            Public Shared Function runExperiment(ByVal SCOPET_Slope As Integer, ByVal SCOPET_TriggerType As Integer, ByVal SCOPET_TriggerSource As Integer, ByVal SCOPEChA_Source As Integer, ByVal SCOPEChA_Range As Double, ByVal SCOPEChA_Offset As Double, ByVal SCOPEChA_Coupling As Integer, ByVal SCOPEChB_Source As Integer, ByVal SCOPEChB_Range As Double, ByVal SCOPEChB_Offset As Double, ByVal SCOPEChB_Coupling As Integer, ByVal SCOPEH_RecordLength As Integer, ByVal SCOPEH_SampleRateHz As Double, ByVal SCOPEH_Acquire As Integer, ByVal FGEN_WaveformType As Integer, ByVal FGEN_Frequency As Double, ByVal FGEN_DCOffset As Double, ByVal FGEN_Amplitude As Double, ByRef interleavedArray As Double, ByVal len As Integer) As Integer
