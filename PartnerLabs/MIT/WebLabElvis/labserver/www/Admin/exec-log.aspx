	...
	Sub ShowDetails_Command(s As Object, e As CommandEventArgs)
		If blnSRRead Then
			...
			If dtrDBQuery.Read() Then
				...
				lblSetupName.Text = CheckForDBNull(dtrDBQuery("setup_name"))
				...
				<td>
					...
					%>
						...
						<table border=0 cellpadding=3 cellspacing=0 width=100%>
							<tr bgcolor="#e0e0e0">
								<th align=left><font class="regular">Broker</font></th><th align=left><font class="regular">Submission Time</font></th><th align=left><font class="regular">Setup</font></th><th align=left><font class="regular">Queue <br>at insert</font></th><th align=left><font class="regular">Exec. <br>Elapsed</font></th><th align=left><font class="regular">Result</font></th>
							</tr>
							<asp:Repeater
								ID="rptExecRecs"
								Runat="Server">
								<ItemTemplate>
									<tr>
										<td><font class="regular"><%#CheckBrokerName(CInt(Container.DataItem("provider_id")), Container.DataItem("provider_name"))%></font></td><td><font class="regular"><%#DisplayDate(Container.DataItem("submit_time"))%>&nbsp;<%#DisplayTime(Container.DataItem("submit_time"))%></font></td><td><font class="regular"><%#Container.DataItem("setup_name")%></font></td><td><font class="regular"><%#Container.DataItem("queue_at_insert")%></font></td><td><font class="regular"><%#Container.DataItem("exec_elapsed")%></font></td><td><font class="regular"><asp:LinkButton Text='<%#DisplayErrorResult(Container.DataItem("error_occurred"))%>' CommandArgument='<%#Container.DataItem("exp_id")%>' OnCommand="ShowDetails_Command" Runat="Server" /></font></td>
									</tr>
								</ItemTemplate>
					...
					%>
						...
						<table border=0 cellpadding=3 cellspacing=0 width=100%>
							...
							<tr>
								<td colspan=2 align=left><font class="regular"><b>Experiment Setup Used:</b>
									<asp:Label
										ID="lblSetupName"
										Runat="Server" /></font>
								</td>
