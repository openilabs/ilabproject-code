...
public class SOAPRequest
{
  ...
  private List paramNames; // contains String
  private List paramValues; // contains String
  ...
  /**
   * Adds a String-valued parameter to this SOAP RPC request.
   */
  public void addParameter(String name, String value)
  {
    paramNames.add(name);
    paramValues.add(Parser.xmlEscape(value));
  }



  /**
   * Adds an integer-array-valued parameter to this SOAP RPC request.
   */
    ...
    throws SOAPFaultException, IOException, InvalidXMLException
  {
    ...
    System.out.println
      ("Invoking web method " + this.methodName + " at " + serviceURL);
    System.out.println
