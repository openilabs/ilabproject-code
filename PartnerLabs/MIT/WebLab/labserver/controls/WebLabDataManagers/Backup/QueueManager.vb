...
Namespace WebLabDataManagers
    ...
    Public Class QueueManager
        ...
        Public Function ExperimentStatus(ByVal intBrokerID As Integer, ByVal intBrokerExpID As Integer) As ExpStatusObject
            ...
            strDBQuery = "SELECT queuePosition, estTimetoRun, estExecTime, estRemainExecTime FROM dbo.qm_ExperimentStatusByRemoteID(@BrokerID, @ExpID, @CurrDateTime);"
            ...
            cmdDBQuery.Parameters.Add("@CurrDateTime", Date.Now())
            dtrDBQuery = cmdDBQuery.ExecuteReader()

            dtrDBQuery.Read()

            esObject = New ExpStatusObject(CInt(dtrDBQuery("queuePosition")), CInt(dtrDBQuery("estTimeToRun")), CInt(dtrDBQuery("estExecTime")), CInt(dtrDBQuery("estRemainExecTime")))
        ...
        Public Function ExperimentStatus(ByVal intLocalExpID As Integer) As ExpStatusObject
            ...
            strDBQuery = "SELECT queuePosition, estTimetoRun, estExecTime, estRemainExecTime FROM dbo.qm_ExperimentStatusByLocalID(@ExpID, @CurrDateTime);"
            cmdDBQuery = New SqlCommand(strDBQuery, conWebLabLS)
        ...
        Public Function QueueLength(ByVal intPriority As Integer) As QueueLengthObject
            ...
            strDBQuery = "SELECT queueLength, estTimeToRun FROM dbo.qm_QueueLength(@Priority, @CurrDateTime);"
            cmdDBQuery = New SqlCommand(strDBQuery, conWebLabLS)
        ...
        Public Function EnqueueJob(ByVal strXMLExpSpec As String, ByVal intPriority As Integer, ByVal strGroups As String, ByVal intBrokerID As Integer, ByVal intBrokerExpID As Integer, ByVal intEstExecTime As Integer, ByVal intDataPoints As Integer, ByVal intDeviceProfileID As Integer) As Integer
            ...
            strDBQuery = "EXEC qm_Enqueue @ExpSpec, @Priority, @Groups, @BrokerID, @RemoteExpID, @EstExecTime, @Points, @ProfileID;"
            cmdDBQuery = New SqlCommand(strDBQuery, conWebLabLS)
