								...
								<ItemTemplate>
										<tr>
											...
											<td>
												<font class="regular"> 
													<%If blnACRead Then%>
														<a href="/admin/usage-classes.aspx?cid=<%#Container.DataItem("class_id")%>" target="main"><%#Container.DataItem("class_name")%></a>
													<%Else%>
										...
										<tr>
											<td>
												<font class="regular">
													...
													<%If blnACRead Then%>
														<a href="/admin/usage-classes.aspx?cid=<%=strClassID%>" target="main"><%=strClassName%></a>
													<%Else
