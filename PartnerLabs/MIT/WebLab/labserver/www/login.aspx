...
<html>
	...
	%>
		...
		//'top.main.location.href.indexOf("main.aspx") == "-1" && ' was in line below, removed to refresh main frame when /admin/main.aspx is present in it)
	...
	%>
		...
		If RPMan.GetClassResourcePermission(CInt(Session("LoggedInClassID")), "DeviceManagement", "canview")
        %>
        
			<font class="title">&nbsp;Device Management</font>
			<br>
			<img src="child.gif" width=17 height=15><img src="arrow-redblack.gif" width=6 height=11> <a href="/admin/active-devices.aspx" class="menu" target="main">Active Devices</a><br>
			<img src="child.gif" width=17 height=15><img src="arrow-redblack.gif" width=6 height=11> <a href="/admin/device-profiles.aspx" class="menu" target="main">Device Profiles</a><br>
			<img src="child.gif" width=17 height=15><img src="arrow-redblack.gif" width=6 height=11> <a href="/admin/device-types.aspx" class="menu" target="main">Device Types</a><br>
			<br>
    ...
    %>
        ...
        <!-- copyright --> <center><font class='small'>&copy; 2002 <a href="http://www.mit.edu" target="_none"><font color="#7F0531"><b>MIT</b></font></a></font></center>
        </font>
