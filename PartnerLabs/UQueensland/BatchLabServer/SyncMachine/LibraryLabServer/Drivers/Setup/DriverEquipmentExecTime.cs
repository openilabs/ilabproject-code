...
namespace Library.LabServer.Drivers.Setup
{
    public partial class DriverEquipment : DriverEquipmentGeneric
    {
        ...
        private SMTableEntry_GetExecutionTime[] smTable_GetExecutionTime = new SMTableEntry_GetExecutionTime[] {
            //
            // Get execution time for given specification
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetExecutionTime, States_GetExecutionTime.sCompleted,
                Consts.STRXML_CmdGetExecutionTime, new string[,] {
        ...
        public override int GetExecutionTime(ExperimentSpecification experimentSpecification)
        {
            ...
            try
            {
                ...
                while (state != States_GetExecutionTime.sCompleted)
                {
                    ...
                    {
                        case States_GetExecutionTime.sGetExecutionTime:
                    ...
                    {
                        case States_GetExecutionTime.sGetExecutionTime:
                            stateExecutionTime = XmlUtilities.GetRealValue(xmlResponseNode, Consts.STRXML_RspExecutionTime, 0);
                            break;
