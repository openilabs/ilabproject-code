...
namespace Library.LabServer.Drivers.Setup
{
    public partial class DriverVoltageVsSpeed : DriverEquipmentGeneric
    {
        ...
        private SMTableEntry_GetExecutionTime[] smTable_GetExecutionTime = new SMTableEntry_GetExecutionTime[] {
            ...
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetStartDCDriveMutTime, States_GetExecutionTime.sGetSetSpeedACDriveTime,
            ...
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetSetSpeedACDriveTime, States_GetExecutionTime.sGetTakeMeasurementTime,
                Consts.STRXML_CmdGetSetSpeedACDriveTime, null
                ),
            //
            // GetTakeMeasurementTime
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetTakeMeasurementTime, States_GetExecutionTime.sGetResetSpeedACDriveTime,
                Consts.STRXML_CmdGetTakeMeasurementTime, null
                ),
            //
            // GetResetSpeedACDriveTime
            //
            new SMTableEntry_GetExecutionTime(States_GetExecutionTime.sGetResetSpeedACDriveTime, States_GetExecutionTime.sGetStopDCDriveMutTime,
                Consts.STRXML_CmdGetSetSpeedACDriveTime, null
                ),
            //
            ...
            try
            {
                ...
                while (state != States_GetExecutionTime.sCompleted)
                {
                    ...
                    switch (entry.currentState)
                    {
                        ...
                        case States_GetExecutionTime.sGetResetSpeedACDriveTime:
