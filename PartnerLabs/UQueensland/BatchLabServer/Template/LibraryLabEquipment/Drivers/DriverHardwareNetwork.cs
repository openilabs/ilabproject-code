...
{
    public class DriverHardwareNetwork : DriverHardware
    {
        #region Class Constants and Variables

        private const string STRLOG_ClassName = "DriverHardwareNetwork";
        ...
        public DriverHardwareNetwork(XmlNode xmlNodeEquipmentConfig)
            : base(xmlNodeEquipmentConfig)
        {
            const string STRLOG_MethodName = "DriverHardwareNetwork";
