...
namespace Library.LabServer.Drivers.Setup
{
    public partial class DriverVoltageVsSpeed : DriverEquipmentGeneric
    {
        ...
        private SMTableEntry_Execute[] smTable_Execute = new SMTableEntry_Execute[] {
            ...
            // StartDCDriveMut
            //
            new SMTableEntry_Execute(States_Execute.sStartDCDriveMut, States_Execute.sSetSpeedACDrive, States_Execute.sStopDCDriveMut,
            ...
            // SetSpeedACDrive
            //
            new SMTableEntry_Execute(States_Execute.sSetSpeedACDrive, States_Execute.sTakeMeasurement, States_Execute.sResetSpeedACDrive,
            ...
            // TakeMeasurement
            //
            new SMTableEntry_Execute(States_Execute.sTakeMeasurement, States_Execute.sResetSpeedACDrive, States_Execute.sResetSpeedACDrive,
                Consts.STRXML_CmdTakeMeasurement, null),
            //
            // ResetSpeedACDrive
            //
            new SMTableEntry_Execute(States_Execute.sResetSpeedACDrive, States_Execute.sStopDCDriveMut, States_Execute.sStopDCDriveMut,
                Consts.STRXML_CmdSetSpeedACDrive, new string[,] {
                    { Consts.STRXML_ReqSpeedACDrive, string.Empty }
                } ),
            //
