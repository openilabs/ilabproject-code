...
<%@ Page language="c#" Inherits="iLabs.ServiceBroker.admin.showAdminExperiment" validateRequest="false" CodeFile="showAdminExperiment.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<div id="outerwrapper">
				...
				<div id="innerwrapper">
							...
							<uc1:displayExperiment id="showExperiment1" runat="server"></uc1:displayExperiment>
