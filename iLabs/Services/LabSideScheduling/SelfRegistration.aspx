<%@ Page language="c#" Inherits="iLabs.Core.SelfRegistration" CodeFile="SelfRegistration.aspx.cs" EnableEventValidation="false" %>
	...
	<body>
		<form method="post" runat="server">
			...
			<uc1:NavBar id="NavBar1" runat="server"></uc1:NavBar>
				<div id="innerwrapper">
					<uc1:register ID="selfReg" runat="server" AgentType="LAB SCHEDULING SERVER" /></div>
