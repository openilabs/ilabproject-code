             ...
             <form id="frmRegister"  action="" method="post"   onload="saveValues">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="2" id="tdServiceName" runat="server"><asp:TextBox ID="txtServiceName" runat="server" Width="496px" ></asp:TextBox></td>
                        </tr>
                        <tr>
                            <th><label for="codebaseUrl">Codebase URL</label></th>
                            <td colspan="2" id="tdCodebaseUrl" runat="server"><asp:TextBox ID="txtCodebaseUrl" runat="server" Width="496px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <th ><label for="webServiceUrl">Web Service URL</label></th>
                            <td colspan="2" id="tdWebServiceUrl" runat="server"><asp:TextBox id="txtWebServiceUrl" runat="server" Width="496px"></asp:TextBox></td>
                        </tr>
                        <tr>
                        ...
                        <tr id="trPasskey" runat="server">
                            ...
                            <td colspan="2"><asp:TextBox ID="txtOutPassKey" runat="server" Width="496px"  Enabled="false" ToolTip="May only be changed by modifying the Web.config file"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <th colspan="2">
                                &nbsp;&nbsp;<asp:Button ID="btnSaveChanges" runat="server" CssClass="button" Text="Save Changes"
                                    ...
                                    OnClientClick="return confirm('Are you sure you want to modify this WebService?\nIf you proceed all references to this site will be modified');" 
