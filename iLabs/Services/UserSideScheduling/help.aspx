...
<%@ Register TagPrefix="uc1" TagName="userNav" Src="NavBar.ascx" %>
<%@ Register TagPrefix="uc1" TagName="banner" Src="banner.ascx" %>
<%@ Page language="c#" Inherits="iLabs.Scheduling.UserSide.help" CodeFile="help.aspx.cs" %>
								...
								<div class="simpleform">
									<table>
										...
										<tr>
											...
											<td><asp:dropdownlist id="ddlWhichLab" Runat="server"></asp:dropdownlist></td>
										</tr>
										<tr>
											<th>
