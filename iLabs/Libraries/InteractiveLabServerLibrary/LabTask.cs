...
namespace iLabs.LabServer.Interactive
{
	...
	public class LabTask
	{
        ...
        public enum eStatus { NotFound = -1, Unknown = 0, Scheduled=2, Pending =4, Waiting=8, Running = 16, Completed=32, Aborted=64, Expired=128 };


        public static string constructSessionPayload(int id, string title, string application, string appUrl, int width, int height, DateTime start, long duration, long taskID, string essURL, string returnTarget, string user, string statusVI)
        {
        ...
        public static string constructTaskXml(long id, string viname, string statusvi, string essURL)
        {
