...
namespace iLabs.Services {
    ...
    public partial class BatchSBProxy : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback RetrieveExperimentResultOperationCompleted;
        ...
        /// <remarks/>
        public BatchSBProxy() {
            this.Url = "http://localhost/ilabwsdl/I_BatchSB.asmx";
        }
        ...
        /// <remarks/>
        public event RetrieveExperimentResultCompletedEventHandler RetrieveExperimentResultCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapHeaderAttribute("sbAuthHeaderValue")]
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://ilab.mit.edu/RetrieveExperimentResult", RequestNamespace="http://ilab.mit.edu", ResponseNamespace="http://ilab.mit.edu", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string RetrieveExperimentResult(int experimentID) {
            object[] results = this.Invoke("RetrieveExperimentResult", new object[] {
                        experimentID});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult BeginRetrieveExperimentResult(int experimentID, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("RetrieveExperimentResult", new object[] {
                        experimentID}, callback, asyncState);
        }
        
        /// <remarks/>
        public string EndRetrieveExperimentResult(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void RetrieveExperimentResultAsync(int experimentID) {
            this.RetrieveExperimentResultAsync(experimentID, null);
        }
        
        /// <remarks/>
        public void RetrieveExperimentResultAsync(int experimentID, object userState) {
            if ((this.RetrieveExperimentResultOperationCompleted == null)) {
                this.RetrieveExperimentResultOperationCompleted = new System.Threading.SendOrPostCallback(this.OnRetrieveExperimentResultOperationCompleted);
            }
            this.InvokeAsync("RetrieveExperimentResult", new object[] {
                        experimentID}, this.RetrieveExperimentResultOperationCompleted, userState);
        }
        
        private void OnRetrieveExperimentResultOperationCompleted(object arg) {
            if ((this.RetrieveExperimentResultCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.RetrieveExperimentResultCompleted(this, new RetrieveExperimentResultCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.42")]
    public delegate void RetrieveExperimentResultCompletedEventHandler(object sender, RetrieveExperimentResultCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.42")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class RetrieveExperimentResultCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal RetrieveExperimentResultCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
