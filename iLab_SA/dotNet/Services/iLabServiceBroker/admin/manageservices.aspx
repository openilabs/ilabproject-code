			...
			<div id="outerwrapper">
				...
				<div id="innerwrapper">
					...
					<div id="pagecontent">
							    ...
							    <div class="unit">
									<table style="WIDTH: 680px; HEIGHT: 460px" cols="3" cellspacing="0" cellpadding="5" border="0">
										<TBODY>
											...
											<td colspan="2" style="width: 560px"><asp:textbox ID="txtBatchHelp" runat="server" Columns="70" Rows="4" TextMode="MultiLine" Visible="false" Width="560px">Note: Batch LabServers require that the LabServer GUID be less than 36 characters.  The incoming passcode is provided by the ServiceBroker, and is used in Weblab based labservers registration of a ServiceBroker. The outgoing passcode is generated by the LabServer and must be provided.</asp:textbox></td>
										   </tr>
											<tr>
											...
											<th style="width: 120px">
												...
												<td colspan="2" style="width: 448px"><asp:textbox id="txtBatchPassIn" Runat="server" Width="418px"
												Tooltip="This is the code generated on the ServiceBroker."></asp:textbox>&nbsp;&nbsp;&nbsp;<asp:Button ID="btnPass" runat="server" CssClass="button" Text="Make Passcode" OnClick="btnPass_Click" /></td>
											</tr>
						...
						</div><!-- end pagecontent div --></div><!-- end innerwrapper div --><br clear="all" />
