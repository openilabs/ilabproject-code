...
{
    /// <summary>
    /// Summary description for FileWatcherDataSource
    /// </summary>
    public class FileWatcherDataSource : LabDataSource
    {
        ...
        private void OnCreated(object source, FileSystemEventArgs e)
        {
            ...
            Logger.WriteLine("File Created: " + e.FullPath);
        ...
        private void OnChanged(object source, FileSystemEventArgs e)
        {
            ...
            switch (e.ChangeType)
            {
                ...
                case WatcherChangeTypes.Changed:
                    ...
                    long len = fInfo.Length;
                    Logger.WriteLine("File Changed: " + e.FullPath + " size: " + len + " \tDate: " + lastWrite);
                    break;
        ...
        {
            // Specify what is done when a file is changed, created, or deleted.
            Logger.WriteLine("File Deleted: " + e.FullPath + " " + e.ChangeType);
        }

        private void OnRenamed(object source, RenamedEventArgs e)
        {
            // Specify what is done when a file is renamed.
            Logger.WriteLine("File: " + e.OldFullPath + " renamed to " + e.FullPath);
        }
    }
}
