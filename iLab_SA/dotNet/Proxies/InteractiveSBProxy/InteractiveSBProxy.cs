...
namespace iLabs.Proxies.ISB {
    ...
    public partial class InteractiveSBProxy : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginRequestAuthorization(string[] types, long duration, string userName, string groupName, string authority, string clientGuid, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public void RequestAuthorizationAsync(string[] types, long duration, string userName, string groupName, string authority, string clientGuid) {
            this.RequestAuthorizationAsync(types, duration, userName, groupName, authority, clientGuid, null);
        }
        
        /// <remarks/>
        public void RequestAuthorizationAsync(string[] types, long duration, string userName, string groupName, string authority, string clientGuid, object userState) {
