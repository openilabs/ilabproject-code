...
namespace iLabs.Proxies.ESS {
    ...
    public partial class ExperimentStorageProxy : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginCreateExperiment(long experimentId, long duration, int userId, int groupId, int clientId, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public void CreateExperimentAsync(long experimentId, long duration, int userId, int groupId, int clientId) {
            this.CreateExperimentAsync(experimentId, duration, userId, groupId, clientId, null);
        }
        
        /// <remarks/>
        public void CreateExperimentAsync(long experimentId, long duration, int userId, int groupId, int clientId, object userState) {
            ...
            this.InvokeAsync("CreateExperiment", new object[] {
                        ...
                        userId,
                        groupId,
                        clientId}, this.CreateExperimentOperationCompleted, userState);
        }
